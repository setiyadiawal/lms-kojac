...
const CDN_BASE = 'https://cdn.jsdelivr.net/npm/kana-svg-data@0.0.2/dist/hiragana';
const CACHE_VERSION = 'v7-stable';
...
export function HiraganaStrokeOrder({ text }: { text: string }) {
